...
const Login = () => {
  ...
  return (
    <div className="px-2 md:px-4 lg:px-8 my-12 ">
        <div className="max-w-lg mx-auto mt-12 px-2 border-2 border-orange-200  p-6 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 rounded-lg shadow-md ">
    ...
    <form onSubmit={handleLogin}>
      ...
      <div className="flex justify-between">
        <button onClick={handleGoogleLogin} className="w-1/2 bg-red-400 text-white font-semibold px-4 py-2 rounded-lg hover:bg-orange-700 transition duration-300 mr-2">Google</button>
        <button onClick={handleGithubLogin} className="w-1/2 bg-gray-700 text-white font-semibold px-4 py-2 rounded-lg hover:bg-gray-400 transition duration-300 ml-2">GitHub</button>
      </div>
    </form>
