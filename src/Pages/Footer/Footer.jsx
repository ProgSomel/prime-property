...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-gray-600 text-base-content flex flex-col md:flex-row justify-between ">
      <nav>
        ...
        <p className="text-gray-200">
          Receive updates, hot deals, tutorials, discounts sent straignt in your{" "}
          <br /> inbox every month
        </p>
        <div className="md:join ">
          ...
          />
          <button className="btn join-item bg-red-500 text-white border-none">Subscribe</button>
        </div>
      </nav>
      <nav>
      ...
      <nav>
        ...
        <a className="link link-hover text-gray-200">Blog</a>
      </nav>
      <nav>
        <h6 className="text-white font-bold text-xl">Social</h6>
